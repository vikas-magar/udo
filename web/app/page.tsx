    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans">
      ...
      <nav className="fixed top-0 left-0 h-full w-64 bg-gray-800 border-r border-gray-700 p-6">
        ...
        <ul className="space-y-4">
          <li>
            <Link href="/" className="block p-3 bg-gray-700 rounded-lg text-white font-medium">
              Dashboard
            </Link>
          </li>
          <li>
            <Link href="/config" className="block p-3 text-gray-400 hover:bg-gray-700 hover:text-white rounded-lg transition">
              Configuration
            </Link>
          </li>
          <li>
